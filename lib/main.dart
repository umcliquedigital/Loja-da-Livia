      ...
      bottomNavigationBar:BottomNavigationBar(
        ...
        items: const <BottomNavigationBarItem>[
          BottomNavigationBarItem(
            icon:  ImageIcon(AssetImage(imageNav0)), // -> Icone
            label: textoNav0, // -> Descrição
          ),
          BottomNavigationBarItem(
            icon: ImageIcon(AssetImage(imageNav1)),
            label: textoNav1,
          ),
          BottomNavigationBarItem(
            icon: ImageIcon(AssetImage(imageNav2)),
            label: textoNav2,
          ),
          BottomNavigationBarItem(
            icon: ImageIcon(AssetImage(imageNav3)),
            label: textoNav3,
          ),
          BottomNavigationBarItem(
            icon: ImageIcon(AssetImage(imageNav4)),
            label: textoNav4,
          ),
        ],
      ),
...
if (bodyElement) {
  bodyElement.style.marginBottom = '35px';
}
document.querySelectorAll(
  'body > div.wrapper > footer > div.footer-top,' +
  'body > div.wrapper > footer > div.footer-middle,' +
  'body > div.wrapper > footer > div.footer-bottom,' +
  'body > div.wrapper > footer > div.footer-logo.py-5,' +
  'body > div.app-fab.app-fab--left > div,' +
  '#app > div.footer.-cart'
